...
// Sequence-ranking logic (bs_sequence_pa / bs_sequence_any, the "most common combos leading
// to outcome X" tool) now lives in lib/pitchSequences.ts — it grew its own EV-integration
// concerns distinct from this file's situational-resolver focus.
